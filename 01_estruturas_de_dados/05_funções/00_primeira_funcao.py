...
## Usar funções torna o código mais legível e possibilita o reaproveitamento de código. Programar baseado em funções, é o mesmo que dizer que
...
exibir_mensagem()
exibir_mensagem_2(nome="Roberth")
exibir_mensagem_3()
